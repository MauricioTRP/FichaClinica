...
public final class GrantCaregiverAccessUseCase
        implements UseCase<GrantCaregiverAccessUseCase.Request, Void> {
    private final MedicalRecordRepository repository;

    public GrantCaregiverAccessUseCase(MedicalRecordRepository repository) {
    ...
    public Void execute(Request request) {
        ...
        medicalRecord.grantCaregiverAccess(request.patientId(), request.caregiverId());
