...
public final class ShareWithHealthcareWorkerUseCase
        implements UseCase<ShareWithHealthcareWorkerUseCase.Request, Void> {
    private final MedicalRecordRepository repository;

    public ShareWithHealthcareWorkerUseCase(MedicalRecordRepository repository) {
    ...
    public Void execute(Request request) {
        ...
        medicalRecord.shareWithHealthcareWorker(request.caregiverId(), request.workerId());
        repository.save(medicalRecord);
        return null;
    }

    public record Request(PatientId patientId, CaregiverId caregiverId, HealthcareWorkerId workerId) {
        public Request {
